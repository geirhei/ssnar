...
public class MapGraphic extends JPanel {
    ...
    public void paintComponent(Graphics g) {
        ...
        paintMap(g2D);
        //paintVertices(g2D); // Paint vertices generated by SLAMrobot
        paintRobots(g2D);
    ...
    private void paintArrayLocations(Graphics2D g2D) {
        g2D.setPaint(Color.black);
        
    }
    
    /**
     * Paints the SLAMrobot's vertices.
     * 
     * @param g2D 
     */
    /*
    private void paintVertices(Graphics2D g2D) {
        ArrayList<Vertex> vertices = gridmap.getVertices();
        for (Vertex vertice : vertices) {
            Color verticeColor = Color.black;
            if (vertice.getType() == Vertex.EXTERIOR) {
                verticeColor = Color.black;
            } else if (vertice.getType() == Vertex.INTERIOR) {
                verticeColor = Color.red;
            } else if (vertice.getType() == Vertex.ILL_DEFINED) {
                verticeColor = Color.yellow;
            }
            g2D.setPaint(verticeColor);
            //int r = 5;
            g2D.fillOval((int)vertice.getPosition().getXValue() - 3, (int)vertice.getPosition().getYValue() - 3, 6, 6);
        }
    }
    */
